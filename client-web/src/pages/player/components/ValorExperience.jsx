...
const ValorExperience = (props) => {
  ...
  return (
    <div style={style}>
      <div id="title" style={{ gridArea: "title" }}>
        Valor
      </div>
      <div id="tier" style={{ gridArea: "tier" }}>
        Mythic
      </div>

      <div id="label_total" style={{ gridArea: "label_total" }}>
        Total
      </div>
      ...
      <div id="label_next" style={{ gridArea: "label_next" }}>
        Next
      </div>
      <div id="bar_next" style={{ gridArea: "bar_next" }}>
        BAR
      </div>
      ...
      <div id="label_streak" style={{ gridArea: "label_streak" }}>
        Streak
      </div>
      <div id="bar_streak" style={{ gridArea: "bar_streak" }}>
        Bar
      </div>
    </div>
  );
