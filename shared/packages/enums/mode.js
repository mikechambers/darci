...
class Mode extends EnumBase {
    ...
    static PRIVATE_MATCHES_ALL = new Mode("PrivateMatchesAll", 32, "Private Matches All");
    static SURVIVAL = new Mode("Survival", 37);
    static COUNTDOWN = new Mode("Countdown", 38);
    static TRIALS_OF_THE_NINE = new Mode("TrialsOfTheNine", 39, "Trials of the Nine");
    ...
    static IRON_BANNER_CONTROL = new Mode("IronBannerControl", 43, "Iron Banner Control");
    static IRON_BANNER_CLASH = new Mode("IronBannerClash", 44, "Iron Banner Clash");
    static IRON_BANNER_SUPREMACY = new Mode("IronBannerSupremacy", 45, "Iron Banner Supremacy");
    ...
    static PRIVATE_MATCHES_CLASH = new Mode("PrivateMatchesClash", 51, "Private Matches Clash");
    static PRIVATE_MATCHES_CONTROL = new Mode("PrivateMatchesControl", 52, "Private Matches Control");
    static PRIVATE_MATCHES_SUPREMACY = new Mode("PrivateMatchesSupremacy", 53, "Private Matches Supremacy");
    static PRIVATE_MATCHES_COUNTDOWN = new Mode("PrivateMatchesCountdown", 54, "Private Matches Countdown");
    static PRIVATE_MATCHES_SURVIVAL = new Mode("PrivateMatchesSurvival", 55, "Private Matches Survival");
    static PRIVATE_MATCHES_MAYHEM = new Mode("PrivateMatchesMayhem", 56, "Private Matches Mayhem");
    static PRIVATE_MATCHES_RUMBLE = new Mode("PrivateMatchesRumble", 57, "Private Matches Rumble");
    ...
    static IRON_BANNER_SALVAGE = new Mode("IronBannerSalvage", 68, "Iron Banner Salvage");
    static PVP_COMPETITIVE = new Mode("PvPCompetitive", 69, "Competitive");
    static PVP_QUICKPLAY = new Mode("PvPQuickplay", 70, "Quickplay");
    static CLASH_QUICKPLAY = new Mode("ClashQuickplay", 71, "Clash Quickplay");
    static CLASH_COMPETITIVE = new Mode("ClashCompetitive", 72, "Clash Competitive");
    static CONTROL_QUICKPLAY = new Mode("ControlQuickplay", 73, "Control Quickplay");
    static CONTROL_COMPETITIVE = new Mode("ControlCompetitive", 74, "Control Competitive");
